...
#ifndef __impPara_impPara_hpp__
#define __impPara_impPara_hpp__
...
int impPara::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int impPara::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int impPara::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t impPara::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* impPara::getTypeName()
{
    return "impPara";
}

int impPara::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int impPara::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
